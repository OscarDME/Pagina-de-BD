...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['entrenamiento'])) {
        ...
        if ($usuario !== null) {
            $sql .= "fk_usuario = :usuario, ";
            $params[':usuario'] = $usuario;
        }

        $sql = rtrim($sql, ', ');
        $sql .= " WHERE id_entrenamiento = :id";
                ...
                <div class="row flex-nowrap">
                    ...
                    <div class="row py-3">
                        <div class="col py-3">
                            <form action="entrenamiento.php" method="POST">
                                ...
                                <div class="row">
                                    <br>
                                    <button type="submit" name="entrenamiento" style="margin: 10px;" value="Submit"
                                        class="btn btn-primary btn-block" href="#">Mostrar entrenamientos</button>
                                </div>
                            </form>
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col container">
                            <h3>Todos los entrenamientos</h3>
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>ID</th>
